...
@class JSQMessagesComposerTextField;
 ...
 */
- (BOOL)composerTextField:(JSQMessagesComposerTextField *)textView shouldPasteWithSender:(id)sender;
 ...
 */
@interface JSQMessagesComposerTextField : UITextField
